...
public class NgonLocation {
	...
	public boolean getLocation(Context context, LocationResult result) {
		...
		if (lm == null) lm = (LocationManager) context
		...
		if (gps_enabled) lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0,
		        locationListenerGps);
		if (network_enabled) lm.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 0, 0,
